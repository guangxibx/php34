...
<!--[if IE 6]>
<script type="text/javascript" src="{{asset('back')}}/{{asset('back')}}/lib/DD_belatedPNG_0.0.8a-min.js" ></script>
...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;" onclick="admin_add('添加管理员','{{url('/admin/admin/create')}}','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加管理员</a></span> <span class="r">共有数据：<strong>{{$admins->total()}}</strong> 条</span> </div>
	<table class="table table-border table-bordered table-bg">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td class="td-manage"><a title="编辑" href="javascript:;" onclick="admin_edit('管理员编辑','{{url('admin/admin/'.$v['id'].'/edit')}}','800','500')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> <a title="删除" href="javascript:;" onclick="admin_del(this,'{{$v->id}}')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
			</tr>
			@endforeach
		</tbody>
	</table>
	<link rel="stylesheet" href="{{asset('back')}}/css/laravel-page.css">
	<div id="pull_right">
		{{$admins->links()}}
...
<script type="text/javascript" src="{{asset('back')}}/{{asset('back')}}/lib/laypage/1.2/laypage.js"></script>
<script type="text/javascript" src="{{asset('back')}}/{{asset('back')}}/lib/My97DatePicker/WdatePicker.js"></script>
