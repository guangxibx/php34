...
<!--[if lt IE 9]>
<script type="text/javascript" src="{{asset('back')}}/{{asset('back')}}/lib/html5.js"></script>
<script type="text/javascript" src="{{asset('back')}}/{{asset('back')}}/lib/respond.min.js"></script>
<script type="text/javascript" src="{{asset('back')}}/{{asset('back')}}/lib/PIE_IE678.js"></script>
<![endif]-->
...
<link href="{{asset('back')}}/{{asset('back')}}/lib/Hui-iconfont/1.0.7/iconfont.css" rel="stylesheet" type="text/css" />
<!--[if IE 6]>
<script type="text/javascript" src="http://{{asset('back')}}/{{asset('back')}}/lib.h-ui.net/DD_belatedPNG_0.0.8a-min.js" ></script>
    ...
    <form class="form form-horizontal" action="" method="post">
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          ...
          <img src="{{captcha_src()}}" id="verify"> <a id="kanbuq" href="javascript:;">看不清，换一张</a> </div>
      </div>
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          <label for="online">
...
<div class="footer">Copyright 你的公司名称 by H-ui.admin.php33</div>
...
<script>
  //单击切换验证码
  $("#verify,#kanbuq").click(function () {
      $('#verify').attr('src','{{captcha_src()}}?_/'+Math.random());
  });
  @if($errors->count())
    layer.msg("{!! implode($errors->all(),'<br />') !!}",{icon:5});
  @endif
</script>
</body>
</html>