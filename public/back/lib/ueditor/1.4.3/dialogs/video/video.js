...
(function(){
    ...
    function convert_url(url){
        ...
        url = utils.trim(url)
            ...
            .replace(/v\.qq\.com\/cover\/[\w]+\/[\w]+\/([\w]+)\.html/i, "{{asset('back')}}/static.video.qq.com/TPout.swf?vid=$1")
            .replace(/v\.qq\.com\/.+[\?\&]vid=([^&]+).*$/i, "{{asset('back')}}/static.video.qq.com/TPout.swf?vid=$1")
    ...
    UploadFile.prototype = {
        ...
        initUploader: function () {
            var _this = this,
                $ = jQuery,    // just in case. Make sure it's not an other {{asset('back')}}/{{asset('back')}}/libaray.
                $wrap = _this.$wrap,
            // 图片容器
