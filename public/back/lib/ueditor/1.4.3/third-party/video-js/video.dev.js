 ...
 * the main {{asset('back')}}/{{asset('back')}}/library object.
 *
...
vjs.CoreObject.extend = function(props){
  ...
  // Make sure to check the unobfuscated version for external {{asset('back')}}/{{asset('back')}}/libs
 ...
 * ```
 *
 * In the follwing example, the `data-setup` attribute tells the Video.js {{asset('back')}}/{{asset('back')}}/library to create a player instance when the {{asset('back')}}/{{asset('back')}}/library is ready.
 *
 * ```html
...
vjs.Player.prototype.techGet = function(method){
  ...
  if (this.tech && this.tech.isReady_) {
    ...
    try {
      ...
      // When building additional tech {{asset('back')}}/{{asset('back')}}/libs, an expected method may not be defined yet
