/*!
* ZeroClipboard
* The ZeroClipboard {{asset('back')}}/{{asset('back')}}/library provides an easy way to copy text to the clipboard using an invisible Adobe Flash movie and a JavaScript interface.
...
(function(window) {
  ...
  var _detectFlashSupport = function() {
    ...
    function isPepperFlash(flashPlayerFileName) {
      return !!flashPlayerFileName && (flashPlayerFileName = flashPlayerFileName.toLowerCase()) && (/^(pepflashplayer\.dll|{{asset('back')}}/{{asset('back')}}/libpepflashplayer\.so|pepperflashplayer\.plugin)$/.test(flashPlayerFileName) || flashPlayerFileName.slice(-13) === "chrome.plugin");
    }
