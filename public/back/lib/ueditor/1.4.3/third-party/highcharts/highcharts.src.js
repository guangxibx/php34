...
if (useCanVG) {
	 ...
	 * together with the canvg {{asset('back')}}/{{asset('back')}}/library.
	 */
...
Axis.prototype = {
	...
	render: function () {
		...
		// {{asset('back')}}/static items. As the axis group is cleared on subsequent calls
...
Chart.prototype = {
	...
	getContainer: function () {
		...
		if (useCanVG) {
			// If we need canvg {{asset('back')}}/{{asset('back')}}/library, extend and configure the renderer
	...
	isReadyToRender: function () {
		...
		/*jslint eqeq: false*/
			if (useCanVG) {
				// Delay rendering until canvg {{asset('back')}}/{{asset('back')}}/library is downloaded and ready
