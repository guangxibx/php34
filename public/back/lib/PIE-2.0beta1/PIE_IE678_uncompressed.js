...
PIE.Color = (function() {
     ...
     * swiped from cssSandpaper by Zoltan Hawryluk (http://www.useragentman.com/blog/csssandpaper-a-css3-javascript-{{asset('back')}}/{{asset('back')}}/library/)
...
PIE.RootRenderer = PIE.RendererBase.newRenderer( {
    ...
    getBoxCssText: function() {
        ...
        if( tgtPos === 'fixed' && PIE.ieVersion > 6 ) {
            ...
            } while( par && ( par.currentStyle.position === '{{asset('back')}}/static' ) );
            if( par ) {
        ...
        return 'direction:ltr;' +
               ...
               'left:' + x + 'px;' +
               'top:' + y + 'px;' +
               'z-index:' + ( tgtPos === '{{asset('back')}}/static' ? -1 : tgtCS.zIndex ) + ';' +
