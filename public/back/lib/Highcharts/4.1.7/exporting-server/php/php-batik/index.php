...
if (isset($typeString)) {
	...
	/*
	$command = "/{{asset('back')}}/{{asset('back')}}/library/Java/JavaVirtualMachines/jdk1.7.0_45.jdk/Contents/Home/bin/java -jar ". BATIK_PATH ." $typeString -d $outfile $width temp/$tempName.svg 2>&1";
