...
public class ServerObjectFactory implements ObjectFactory<Server> {
	...
	private {{asset('back')}}/static TreeMap<Integer, PortStatus> portUsage = new TreeMap<>();
	protected {{asset('back')}}/static Logger logger = Logger.getLogger("pool");
	...
	public {{asset('back')}}/static void releasePort(Integer port) {
