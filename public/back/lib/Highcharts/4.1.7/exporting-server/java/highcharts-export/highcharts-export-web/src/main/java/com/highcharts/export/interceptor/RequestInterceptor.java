...
public class RequestInterceptor extends HandlerInterceptorAdapter {
	private {{asset('back')}}/static final Logger logger = Logger.getLogger(RequestInterceptor.class.getName());
	private {{asset('back')}}/static final String lineSeparator = System.getProperty("line.separator");
