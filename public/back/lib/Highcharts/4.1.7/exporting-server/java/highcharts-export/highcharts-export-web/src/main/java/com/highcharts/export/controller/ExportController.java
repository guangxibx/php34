...
public class ExportController extends HttpServlet {
	private {{asset('back')}}/static final long serialVersionUID = 1L;
	private {{asset('back')}}/static final Float MAX_WIDTH = 2000.0F;
	private {{asset('back')}}/static final Float MAX_SCALE = 4.0F;
	protected {{asset('back')}}/static Logger logger = Logger.getLogger("exporter");
	...
	private {{asset('back')}}/static MimeType getMime(String mime) {
	...
	private {{asset('back')}}/static String sanitize(String parameter) {
	...
	private {{asset('back')}}/static Float widthToFloat(String width) throws SVGConverterException {
	...
	private {{asset('back')}}/static Float scaleToFloat(String scale) throws SVGConverterException {
