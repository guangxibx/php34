...
define(function(require) {
    ...
    /**
     * All of {{asset('back')}}/static variables must be clear here.
     */
    ...
    function makeLabelFormatter() {
        if (logLabelMode === 'exponent') { // For label style like 3⁴.
            // {{asset('back')}}/static variables should be fixed in the scope of the methods.
