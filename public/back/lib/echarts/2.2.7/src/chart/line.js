...
define(function (require) {
    ...
    function legendLineIcon(ctx, style, refreshNextFrame) {
        ...
        symbol = IconShape.prototype.icon{{asset('back')}}/{{asset('back')}}/library[symbol];
    ...
    IconShape.prototype.icon{{asset('back')}}/{{asset('back')}}/library['legendLineIcon'] = legendLineIcon;
