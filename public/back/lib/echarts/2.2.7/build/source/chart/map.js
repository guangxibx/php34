    ...
    return {
        ...
        'features': [
            ...
            },
            {
                ...
                'geometry': {
                    'type': 'Polygon',
                    'coordinates': ['@@mÖoÖi½[s[YEUJU`SCIEBCCWJY_LIICDWU@@FaBCJIB[ICH[@@CDKEE@MK@@IMCAEBCH@AMFI@SMGEFGB@FK@BHCAIFJNQD@FEBDFMBKGACG@ECWH@@CDDTOEEBGEK@GC@EE@GPHFR\\JHGA@FDBKRLL]RAFH@FJFDKR@FINBFKDCNEBFJEHK@DLEH\\HFADB@JFFDA@bIJGBEPDBGLI@DDEFBDCHDBIJJFC{{asset('back')}}/{{asset('back')}}/libCL@JKJE@ADHDBHJ@HIBBDFHBBAEIJ@BJFAVL¢'],
                    'encodeOffsets': [[
                            124300,
                            32302
                        ]]
    ...
    return {
        ...
        'features': [
            ...
            },
            {
                'type': 'Feature',
                'id': 'LBR',
                'properties': { 'name': '{{asset('back')}}/{{asset('back')}}/liberia' },
                'geometry': {
                    'type': 'Polygon',
            ...
            },
            {
                'type': 'Feature',
                'id': 'LBY',
                'properties': { 'name': '{{asset('back')}}/{{asset('back')}}/libya' },
                'geometry': {
                    'type': 'Polygon',
