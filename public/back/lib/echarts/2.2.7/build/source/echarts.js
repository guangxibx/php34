...
define('echarts/echarts', [
    ...
    Echarts.prototype = {
        _init: function () {
            ...
            var component{{asset('back')}}/{{asset('back')}}/library = require('./component');
            component{{asset('back')}}/{{asset('back')}}/library.define('title', require('./component/title'));
            component{{asset('back')}}/{{asset('back')}}/library.define('tooltip', require('./component/tooltip'));
            component{{asset('back')}}/{{asset('back')}}/library.define('legend', require('./component/legend'));
        ...
        _render: function (magicOption) {
            ...
            this._chartList = [];
            var chart{{asset('back')}}/{{asset('back')}}/library = require('./chart');
            var component{{asset('back')}}/{{asset('back')}}/library = require('./component');
            ...
            for (var i = 0, l = componentList.length; i < l; i++) {
                ...
                if (magicOption[componentType]) {
                    if (component) {
                        ...
                        ComponentClass = component{{asset('back')}}/{{asset('back')}}/library.get(/^[xy]Axis$/.test(componentType) ? 'axis' : componentType);
            ...
            for (var i = 0, l = magicOption.series.length; i < l; i++) {
                ...
                if (!chartMap[chartType]) {
                    ...
                    ChartClass = chart{{asset('back')}}/{{asset('back')}}/library.get(chartType);
                    if (ChartClass) {
...
define('zrender/zrender', [
    ...
    var self = {};
    var _component{{asset('back')}}/{{asset('back')}}/library = {};
    ...
    var legendIcon = {
        ...
        force: function (ctx, style) {
            IconShape.prototype.icon{{asset('back')}}/{{asset('back')}}/library.circle(ctx, style);
        },
    ...
    for (var k in legendIcon) {
        IconShape.prototype.icon{{asset('back')}}/{{asset('back')}}/library['legendicon' + k] = legendIcon[k];
    }
    ...
    var self = {};
    var _chart{{asset('back')}}/{{asset('back')}}/library = {};
    self.define = function (name, clazz) {
        _chart{{asset('back')}}/{{asset('back')}}/library[name] = clazz;
        return self;
    };
    self.get = function (name) {
        return _chart{{asset('back')}}/{{asset('back')}}/library[name];
    };
    return self;
    ...
    function timelineControl(ctx, style) {
        ...
        if (symbol === 'last') {
            ...
            symbol = IconShape.prototype.icon{{asset('back')}}/{{asset('back')}}/library.image;
            symbol(ctx, {
                x: x,
                y: y,
                width: width,
    ...
    IconShape.prototype.icon{{asset('back')}}/{{asset('back')}}/library['timelineControl'] = timelineControl;
    ...
    Icon.prototype = {
        type: 'icon',
        icon{{asset('back')}}/{{asset('back')}}/library: {
            mark: _iconMark,
        ...
        buildPath: function (ctx, style, refreshNextFrame) {
            if (this.icon{{asset('back')}}/{{asset('back')}}/library[style.iconType]) {
                this.icon{{asset('back')}}/{{asset('back')}}/library[style.iconType].call(this, ctx, style, refreshNextFrame);
            } else {
                ctx.moveTo(style.x, style.y);
                ctx.lineTo(style.x + style.width, style.y);
                ctx.lineTo(style.x + style.width, style.y + style.height);
    ...
    DataZoom.prototype = {
        ...
        _calculScatterMap: function (seriesIndex) {
            ...
            var component{{asset('back')}}/{{asset('back')}}/library = require('../component');
            var Axis = component{{asset('back')}}/{{asset('back')}}/library.get('axis');
    ...
    function smartLogSteps(opts) {
        clear{{asset('back')}}/staticVariables();
        custOpts = opts || {};
        reformSetting();
        makeTicksList();
        return [
    ...
    function clear{{asset('back')}}/staticVariables() {
